				...
				<div class="modal-body">
					<form action="#" method="post" class="form-horizontal" >
                            ...
                            <ul class="nav nav-pills">
                                <h4>I am</h4>
                                <li class="active"><a data-toggle="pill" href="#" > Admin</a></li>
                                <li><a data-toggle="pill" href="#"> AAI</a></li>
                                <li><a data-toggle="pill" href="#"> Crime</a></li>
                                <li><a data-toggle="pill" href="#"> RTA</a></li>
                                <li><a data-toggle="pill" href="#"> Citizen</a></li>
                                <li><a data-toggle="pill" href="#"> Staff</a></li>
                            </ul>
				...
				<div class="modal-body">
					<s:form action="registration" method="post" class="form-horizontal" onsubmit="return checkSignupForm(this);">
						...
						<div class="form-group">
							...
							<div class="col-xs-8">
								<input type="text" pattern="[0-9]{10}" id="mobileno" class="form-control" placeholder="10 digit mobile no."  required/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-8">
								<input class="form-control" type="password" id="pwd1"
									placeholder="Enter password here" name="pwd1" onchange="form.pwd2.pattern = this.value;" required/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-8">
								<input title="Please enter the same Password as above" class="form-control" type="password" id="pwd2"
									placeholder="Repeat password here" name="pwd2" onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');" required/>
							</div>
						</div>
                        <div class="form-group">
                            <label class="control-label col-xs-4">
                                <i class="fa fa-question"></i> Secret Question
                            </label>
                            <div class="col-xs-8">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-4">
                                <i class="fa fa-archive"></i> Answer
                            </label>
                            <div class="col-xs-8">
